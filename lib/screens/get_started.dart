          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(
                    height: 24), // Spacing below the get started image
                const Text(
                ...
                const SizedBox(
                    height: 16), // Additional space between the texts
                const Padding(
                  padding: EdgeInsets.symmetric(horizontal: 16),
                  child: Text(
                    'Introducing Defendroid Scanner - the world\'s fastest malware detection with a vast server network ensuring ultimate protection for your devices. Welcome to enhanced cybersecurity!',
                    style: TextStyle(
                      fontFamily: 'Urbanist',
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        const Color(0xFFD29E1A), // Button color 'D29E1A'
                  ),
                  child: const Text(
                    'Get Started',
                    style: TextStyle(
